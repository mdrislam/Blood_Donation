...
public class Caouse_SelectedAdapter extends RecyclerView.Adapter<Caouse_SelectedAdapter.CauseSelectedViewHoalder> {
    private List<String> caouseNames = new ArrayList<>();
    private Context context;
    private ClickButton bloodToogleButtonClick;
    private int selsctPosition = -1;

    public Caouse_SelectedAdapter(Context context, List<String> caouseNames, ClickButton bloodToogleButtonClick) {
